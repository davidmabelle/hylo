...
export default function PublicPageHeader () {
  ...
  return (
    <div className='bg-white/10 shadow-md'>
      <Helmet>
        <title>{t('Public')} | CoCreators</title>
        <meta name='description' content='CoCreators: Public content' />
      </Helmet>
      <div className='w-full mx-auto px-4'>
        <div className='flex justify-between items-center h-16'>
          <a href='/'>
            <img className='h-8 dark:hidden' src='/assets/navy-merkaba.svg' alt={t('CoCreators logo')} />
            <img className='h-8 hidden dark:block' src='/assets/white-merkaba.svg' alt={t('CoCreators logo')} />
          </a>
